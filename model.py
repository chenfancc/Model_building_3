...
class BiLSTM_Conv1d_3(nn.Module):
    def __init__(self):
        super(BiLSTM_Conv1d_3, self).__init__()
        self.lstm = nn.LSTM(input_size=5, hidden_size=256, num_layers=3, batch_first=True, bidirectional=False)
        self.bn = nn.BatchNorm1d(512)
